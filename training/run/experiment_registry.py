...
EXPERIMENT_SPECS = (
    ...
    ExperimentSpec(
        ...
        train=TrainDefaults(
            description="Train the soft-SCNP full-image variant without any disMap loss prior on Dataset503.",
        ...
        predict=PredictDefaults(
            description="Predict and validate the soft-SCNP full-image variant without any disMap loss prior on Dataset503.",
            default_trainer="nnUNetTrainerSoftSCNPNoFDM",
    ...
    ExperimentSpec(
        ...
        task_dir_name="scnp_soft_variants",
        train=TrainDefaults(
            description="Train the soft-SCNP variant with a sigmoid soft-FDM gate on Dataset503.",
        ...
        predict=PredictDefaults(
            description="Predict and validate the soft-SCNP variant with a sigmoid soft-FDM gate on Dataset503.",
            default_trainer="nnUNetTrainerSoftSCNPSoftFDM",
    ...
    ExperimentSpec(
        ...
        task_dir_name="scnp_soft_variants",
        train=TrainDefaults(
            description="Train the hard-SCNP variant with a sigmoid soft-FDM gate on Dataset503.",
        ...
        predict=PredictDefaults(
            description="Predict and validate the hard-SCNP variant with a sigmoid soft-FDM gate on Dataset503.",
            default_trainer="nnUNetTrainerSCNPSoftFDM",
    ...
    ExperimentSpec(
        ...
        task_dir_name="scnp_soft_variants",
        train=TrainDefaults(
            description="Train the hard-SCNP full-image variant without any disMap loss prior on Dataset503.",
        ...
        predict=PredictDefaults(
            description="Predict and validate the hard-SCNP full-image variant without any disMap loss prior on Dataset503.",
            default_trainer="nnUNetTrainerHardSCNPNoFDM",
