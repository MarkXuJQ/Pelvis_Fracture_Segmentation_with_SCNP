...
def main(
    *,
    task_dir: Path,
    description: str = "Train a CT-only multi-RF SCNP model on the stage-2 masked-CT training dataset (rf=3 @ thr=0.3, rf=5 @ thr=0.5).",
) -> None:
    ...
    parser.add_argument("--trainer_name", type=str, default="nnUNetTrainerSCNPMultiRFLoss")
    ...
    parser.add_argument("--split_mode", type=str, default="keep_existing", choices=["patient", "keep_existing"])
    ...
    parser.add_argument("--scnp_rf_low", type=int, default=3)
    parser.add_argument("--scnp_rf_high", type=int, default=5)
    ...
    parser.add_argument("--scnp_fdm_low", type=float, default=0.3)
    parser.add_argument("--scnp_fdm_high", type=float, default=0.5)
    ...
    os.environ["NNUNET_SCNP_RF_LOW"] = str(int(args.scnp_rf_low))
    os.environ["NNUNET_SCNP_RF_HIGH"] = str(int(args.scnp_rf_high))
    ...
    os.environ["NNUNET_SCNP_FDM_LOW"] = str(float(args.scnp_fdm_low))
    os.environ["NNUNET_SCNP_FDM_HIGH"] = str(float(args.scnp_fdm_high))
    ...
    train_env["PYTHONPATH"] = build_overlay_pythonpath(
        ...
        required_relative_paths=[
            "nnunetv2/training/nnUNetTrainer/nnUNetTrainerSCNPMultiRFLoss.py",
